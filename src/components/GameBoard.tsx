    ...
    return (
        <div>
            <div ref={props.forwardRef}
                ...
                <button
                    ref={buttons.button0}
                    className={classNames('bg-yellow-600 cursor-not-allowed', {'hover:bg-yellow-500 transition !cursor-pointer': props.allowUserInputs})}
                    disabled={!props.allowUserInputs} onClick={() => props.addNoteToUserInputs(0)}
                />
                <button
                    ref={buttons.button1}
                    className={classNames('bg-blue-600 cursor-not-allowed', {'hover:bg-blue-500 transition !cursor-pointer': props.allowUserInputs})}
                    disabled={!props.allowUserInputs}
                    onClick={() => props.addNoteToUserInputs(1)}/>
                <button
                    ref={buttons.button2}
                    className={classNames('bg-green-600 cursor-not-allowed', {'hover:bg-green-500 transition !cursor-pointer': props.allowUserInputs})}
                    disabled={!props.allowUserInputs}
                    onClick={() => props.addNoteToUserInputs(2)}/>
                <button
                    ref={buttons.button3}
                    className={classNames('bg-red-600 cursor-not-allowed', {'hover:bg-red-500 transition !cursor-pointer': props.allowUserInputs})}
                    disabled={!props.allowUserInputs}
